<template>
  <view class="page-index">
    ...
    >
      <view class="bg">
        <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/bannerBg.png" />
      </view>
      <swiper
        class="img"
        indicator-dots="true"
    ...
    <view class="nav-box">
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-new.png" />
        </view>
        <view class="text">
          新品推荐
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-sale.png" />
        </view>
        <view class="text">
          打折特惠
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-group.png" />
        </view>
        <view class="text">
          优惠团购
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-flash.png" />
        </view>
        <view class="text">
          限时秒杀
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-coupon.png" />
        </view>
        <view class="text">
          领券中心
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-member.png" />
        </view>
        <view class="text">
          会员中心
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-distribution.png" />
        </view>
        <view class="text">
          分销中心
        </view>
      ...
      >
        <view class="icon">
          <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/icon-integral.png" />
        </view>
        <view class="text">
          积分商城
        </view>
