      ...
      <view class="header">
        ...
        <view class="sortbar">
          ...
          >
            <image
              v-if="isLineProds"
              src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/list-row-w.png"
            />
            <image
              v-else
              src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/list-line-w.png"
            />
          </view>
        </view>
      </view>
