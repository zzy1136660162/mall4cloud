    ...
    <view class="chat-container">
        ...
        <view class="input-area">
            <view class="input-main">
                <input class="message-input" placeholder="请输入您的问题..." v-model="inputValue" confirm-type="send" @confirm="sendMessage" />
...
export default {
    ...
    onLoad() {
        ...
        const userInfo = uni.getStorageSync('cloudUserDetails') || {}
        log('获取用户信息', userInfo)
    ...
    methods: {
        async initChatSession() {
            ...
            try {
                const userData = {
                    userId: uni.getStorageSync('cloudUserDetails')?.userId,
                    ...this.userInfo
                }
