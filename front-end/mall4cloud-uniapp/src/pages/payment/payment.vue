  ...
  <view class="payment">
    ...
    <radio-group class="ways">
      <label class="item">
        <view class="pay-name">
          <view class="img">
            <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/balancePay.png" />
          </view>
      ...
      <label class="item">
        <view class="pay-name">
          <view class="img">
            <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/alipay.png" />
          </view>
      ...
      <label class="item">
        <view class="pay-name">
          <view class="img">
            <image src="https://www.jiedongyouxuan.com/public-files/jiedong_weapp_static/images/wxpay.png" />
          </view>
