...
const { visible, brandName, resourcesUrl, pageVO, brandListLoading, singleSelectBrandId } = toRefs(Data)
...
const getBrandList = () => {
  getBrandByCategoryId({ ...Data.pageQuery, name: Data.brandName }).then(res => {
    Data.pageVO.list = res.list || []
