<template>
    <!-- pages/activity/hot/activity_hot.wxml -->
    <view class="page">
        <!-- 顶部标题栏 -->
        <view class="header">
            <view class="nav-bar">
        ...
        <view class="activity-banner">
            <image class="banner-bg" src="https://www.lslnii.com/upload/NFSImgFile/appl/images/2025/12/20260313142047334_666195650315.png" mode="aspectFill" />
            <view class="banner-content">
                <text class="banner-title">超级爆品</text>
                <text class="banner-desc">精选全网热销爆款，佣金高转化好</text>
            </view>
        </view>
            ...
            <view class="product-item" @tap="goToProductDetail" :data-id="item.id" v-for="(item, index) in products" :key="index">
                ...
                <view class="product-info">
                    ...
                    <view class="product-tags">
                        <text class="tag hot" v-if="item.isHot">爆款</text>
...
export default {
    ...
    methods: {
        async loadProducts() {
            ...
            try {
                const res = await productService.getActivityProducts('hot', this.page, this.pageSize);
                uni.hideLoading();
...
<style>
/* pages/activity/hot/activity_hot.wxss */
</style>
