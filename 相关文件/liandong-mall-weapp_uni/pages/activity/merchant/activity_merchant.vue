<template>
    <view class="activity-container">
        ...
        <view class="activity-header">
            ...
            <text class="header-title">商家优选</text>
        </view>
        ...
        <view class="activity-banner">
            ...
            <view class="banner-content">
                ...
                <text class="banner-desc">优质商家精选商品，品质有保障</text>
            </view>
        </view>
            ...
            <view class="product-item" @tap="goToProductDetail" :data-id="item.id" v-for="(item, index) in products" :key="index">
                ...
                <view class="product-info">
                    ...
                    <view class="product-tags">
                        <text class="tag merchant">商家优选</text>
...
export default {
    ...
    methods: {
        async loadProducts() {
            ...
            try {
                const res = await productService.getActivityProducts('merchant', this.page, this.pageSize);
                uni.hideLoading();
...
<style>
/* pages/activity/merchant/activity_merchant.wxss */
</style>
