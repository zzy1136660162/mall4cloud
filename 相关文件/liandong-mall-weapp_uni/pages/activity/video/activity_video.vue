<template>
    <view class="activity-container">
        ...
        <view class="activity-header">
            ...
            <text class="header-title">视频热卖</text>
        </view>
        ...
        <view class="activity-banner">
            ...
            <view class="banner-content">
                ...
                <text class="banner-desc">短视频爆款商品，流量转化率高</text>
            </view>
        </view>
            ...
            <view class="product-item" @tap="goToProductDetail" :data-id="item.id" v-for="(item, index) in products" :key="index">
                ...
                <view class="product-info">
                    ...
                    <view class="product-tags">
                        <text class="tag video">视频爆款</text>
...
export default {
    ...
    methods: {
        async loadProducts() {
            ...
            try {
                const res = await productService.getActivityProducts('video', this.page, this.pageSize);
                uni.hideLoading();
...
<style>
/* pages/activity/video/activity_video.wxss */
</style>
